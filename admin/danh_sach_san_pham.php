                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="?pages=sua_san_pham&idsp=<?= $sp["idsp"] ?>&idloai=<?= $sp["idloai"] ?>&anh=<?= $sp["anh"] ?>&tensp=<?= $sp["tensp"] ?>&soluong=<?= $sp["soluong"] ?>&gia=<?= $sp["gia"] ?>&mota=<?= $sp["mota"] ?>" class="d-block btn btn-light m-1"><i class="fa-solid fa-pen-to-square me-3"></i>Sửa</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
